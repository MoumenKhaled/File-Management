...
Route::middleware('throttle:200000,1')->group(function () {
Route::group(['middleware'=>['LoggingAspect','SecurityAspect']],function (){
    ...
    Route::middleware(['active_acount','auth:sanctum'])->group(function () {
        //for admin
    Route::get('/list_files', [AdminController::class, 'list_files']);
        //for users
    ...
    Route::post('/check_in_list_public_files', [PublicController::class, 'check_in_list_public_files'])->middleware('TransactionAspect');
    ...
    Route::get('/check_in_group_file/{file_id}', [GroupController::class, 'check_in_group_file'])->middleware('TransactionAspect');
    Route::post('/check_out_group_file', [GroupController::class, 'check_out_group_file']);
    Route::post('/check_in_list_of_group_files', [GroupController::class, 'check_in_list_of_group_files'])->middleware('TransactionAspect');
    Route::get('/my_reserved_file', [GroupController::class, 'my_reserved_file']);
    Route::get('/number_of_reserved_files', [GroupController::class, 'number_of_reserved_files']);
      //report
